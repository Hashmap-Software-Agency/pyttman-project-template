...
FEATURES = [
    "myapp.features.clockfeature.ClockFeature",
    "myapp.features.MusicFeature.MusicFeature"
]
...
CLIENTS = [
    {
        "module": "pyttman.clients.builtin.cli.CliClient"
    },
    {
        "module": "pyttman.clients.community.discord.client.DiscordClient",
        "token": "DISCORD_FOO_BAR_TOKEN",
        "guild": "DISCORD_FOO_BAR_GUILD",
    },
]
